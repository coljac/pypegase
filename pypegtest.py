import unittest
import os.path
from pypegase import PEGASE, SFR, IMF, Extinction, SNII_ejecta
...
class TestPyPegase(unittest.TestCase):
    ...
    def test_001_PEGASEDefaults(self):
        ...
        self.assertTrue(peg.ssps.galactic_winds)
    ...
    def test_010_Pegase(self):
        ...
        ssps_file = PEGASE._read_file(peg.name + "_SSPs.dat")
        ...
        scenarios_file = PEGASE._read_file(peg.name + "_scenarios.dat")
